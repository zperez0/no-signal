...
const ParksControl = () => {
  return (
    <>
      <div className="background-parks">
                ...
                <div className="mb-4 rounded-lg shadow-lg bg-white max-w-sm">
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-700 text-base mb-4">
                      ...
                      persistence of life, and the tranquility of the High
                      Sierra. First protected in 1864, Yosemite National Park is
                      best known for its waterfalls, but within its nearly 1,200
                      square miles, you can find deep valleys, grand meadows,
              ...
              <div className="flex justify-center">
                <div className="mb-4 rounded-lg shadow-lg bg-white max-w-sm">
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-700 text-base mb-4">
                      On March 1, 1872, Yellowstone became the first national
                      park for all to enjoy the unique hydrothermal and geologic
                ...
                <div className="mb-4 rounded-lg shadow-lg bg-white max-w-sm">
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-700 text-base mb-4">
                      ...
                      seeking wilderness steeped in human history. Relive the
                      days of old through historic chalets, lodges, and the
                ...
                <div className="mb-4 rounded-lg shadow-lg bg-white max-w-sm">
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-700 text-base mb-4">
                      ...
                      encompasses 278 miles (447 km) of the Colorado River and
                      adjacent uplands. Located on the ancestral homeland of 11
                      Associated Tribes, Grand Canyon is one of the most
                      spectacular examples of erosion anywhere in the
                      world—unmatched in the incomparable vistas it offers
                      visitors on the rim. South Rim and North Rim are open 24
                      hours.
                    </p>
                  </div>
                </div>
                ...
                <div className="mb-4 rounded-lg shadow-lg bg-white max-w-sm">
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-700 text-base mb-4">
                      ...
                      Gaze up at massive sandstone cliffs of cream, pink, and
                      red that soar into a brilliant blue sky. Experience
                      wilderness in a narrow slot canyon. Zions unique array of
                      plants and animals will enchant you as you absorb the rich
                      history of the past and enjoy the excitement of present
                      day adventures.
                    </p>
                  </div>
                </div>
                ...
                <div className="mb-4 rounded-lg shadow-lg bg-white max-w-sm">
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-700 text-base mb-4">
                      ...
                      glacier-capped mountains, old-growth temperate rain
                      forests, and over 70 miles of wild coastline. Come
                      explore!
                    </p>
                  </div>
                </div>
                ...
                <div className="mb-4 rounded-lg shadow-lg bg-white max-w-sm">
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-700 text-base mb-4">
                      ...
                      as a monument to the people who fought to protect it.
                      These are mountains of the imagination. Mountains that led
                      to the creation of Grand Teton National Park where you can
                      explore over two hundred miles of trails, float the Snake
                      River, and enjoy the serenity of this remarkable place.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="mb-4 rounded-lg shadow-lg bg-white max-w-sm">
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-700 text-base mb-4">
                      ...
                      environments. From meadows found in the montane life zone
                      to glistening alpine lakes and up to the towering mountain
